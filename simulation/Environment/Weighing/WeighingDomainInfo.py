...
class WeighingDomainInfo(object):
    ...
    def set_domain_parameter_all_space(self, domain_range=None, randomization_flag=True, flag_list=None):
        ...
        self.ball_radius = DomainParameter(name='ball_radius', initial_value=0.0050, min_value=0.0045, max_value=0.0055, sampling_method=flag_list[0])
        self.ball_mass = DomainParameter(name='ball_mass', initial_value=0.000030, min_value=0.000027, max_value=0.000033, sampling_method=flag_list[1])
        ...
        self.gravity = DomainParameter(name='gravity', initial_value=-1., min_value=-1.2, max_value=-0.8, sampling_method=flag_list[7])
