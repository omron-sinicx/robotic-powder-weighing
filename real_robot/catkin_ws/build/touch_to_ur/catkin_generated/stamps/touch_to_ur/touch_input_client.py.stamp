    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            if touchInput != None:
                ...
                if upDown < self.coordLimitDown_Touch: upDown = self.coordLimitDown_Touch
                if upDown > self.coordLimitUp_Touch: upDown = self.coordLimitUp_Touch
                if forwardBackward < self.coordLimitForward_Touch: forwardBackward = self.coordLimitForward_Touch
                if forwardBackward > self.coordLimitBackward_Touch: forwardBackward = self.coordLimitBackward_Touch
                ...
                if _publish: self.urPosPublisher.publish(pose)
            r.sleep()
