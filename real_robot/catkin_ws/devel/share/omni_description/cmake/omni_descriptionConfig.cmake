...
if("TRUE" STREQUAL "TRUE")
  set(omni_description_SOURCE_PREFIX /home/yuki-kadokawa/catkin_ws/src/Geomagic_Touch_ROS_Drivers/omni_description)
  set(omni_description_DEVEL_PREFIX /home/yuki-kadokawa/catkin_ws/devel)
  ...
  set(omni_description_INSTALL_PREFIX /home/yuki-kadokawa/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'omni_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yuki-kadokawa/catkin_ws/src/Geomagic_Touch_ROS_Drivers/omni_description/${idir}'.  ${_report}")
    endif()
